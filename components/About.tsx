export function About() {
  return (
    <section id="about" className="border-b border-white/10 bg-slate-950 py-20">
      <div className="section-shell">
        <div className="max-w-3xl rounded-lg border border-white/10 bg-slate-900/70 p-6 shadow-soft sm:p-8">
